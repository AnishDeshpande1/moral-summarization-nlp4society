"""Analyze the core evaluation metrics for the DeepSeek-R1-Distill-Qwen-32B run.
...
def print_insights(summary, coverage):
    print('=' * 78)
    print('CORE METRIC INSIGHTS  (model: DeepSeek-R1-Distill-Qwen-32B, 400 articles)')
    print('=' * 78)
