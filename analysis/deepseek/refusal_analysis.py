"""Classify every DeepSeek-R1-Distill-Qwen-32B response and quantify refusals & format failures.
...
def print_insights(by_strat, by_strat_dataset):
    print('=' * 78)
    print('REFUSAL & FORMAT ANALYSIS  (model: DeepSeek-R1-Distill-Qwen-32B, 400 articles/strategy)')
    print('=' * 78)
